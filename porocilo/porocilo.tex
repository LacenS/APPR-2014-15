...
\newpage
\begin{figure}
 \includepdf[pages={1-3},nup=1x3]{../slike/zemljevid1.pdf}
\end{figure}
...
\begin{figure}
  \includepdf[pages={1-2},nup=1x2]{../slike/zemljevid2.pdf}
\end{figure}
...
\begin{figure}
  \includepdf[pages={1-2},nup=1x2]{../slike/zemljevid3.pdf}
\end{figure}
...
\begin{figure}
  \includepdf[pages={1},nup=1x2]{../slike/zemljevid4.pdf}
\end{figure}
